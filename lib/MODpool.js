...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    var bfblog = function(text) { _this.emit('log', 'special', text); }; 
    ...
    function SetupJobManager(){
        ...
        _this.jobManager.on('newBlock', function(blockTemplate){
            ...
            bfblog("jobid1: "+shareData.job+" blockreward: "+shareData.blockreward
                +" difficulty: "+shareData.difficulty+ " shareDiff: "+shareData.shareDiff
                +" blockDiff: "+shareData.blockDiff+ " blockdiffactual: "+shareData.blockdiffactual
                +" blockHash: "+shareData.blockHash+ " blockHashInvalid: "+shareData.blockHashInvalid
                +" blockhex: "+shareData.blockHex);
    ...
    function StartStratumServer(finishedCallback){
        ...
        _this.stratumServer.on('started', function(){
            ...
            client.on('difficultyChanged', function(diff){
                ...
                bfblog("jobid:  "+params.jobId+" client.previousDifficulty: "+client.previousDifficulty
                    +" client.difficulty: "+client.difficulty+" client.extraNonce1: "+client.extraNonce1
                    + " params.extraNonce2: "+params.extraNonce2+" params.nTime: "+params.nTime
                    +" params.nonce: "+params.nonce+" client.remoteAddress: "+client.remoteAddress
                    +" client.socket.localPort: "+client.socket.localPort+ " params.name: "+params.name);
